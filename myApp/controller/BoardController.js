  ...
  createBoard = async (req, res) => {
    ...
    if (newBoard.bgImg === undefined || newBoard.bgImg === null) {
      newBoard.bgImg = {
        ...
        type: "image/jpg",
        data: "https://x-career-06-team1-be.onrender.com/static/default-board-background-img.jpg",
  ...
  updateBoardByID = async (req, res) => {
    ...
    if (value.bgImg) {
      ...
      let img = {
        ...
        url: `https://x-career-06-team1-be.onrender.com/static/images/${uploadImage.name}`,
